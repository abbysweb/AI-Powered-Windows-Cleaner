...
class ScannerResultsWidget(QWidget):
    ...
    def setup_ui(self):
        ...
        self.tree.setHeaderLabels(["File Name", "Location", "Category", "Size", "Risk Score"])
        ...
        # Add dummy data
        item1 = QTreeWidgetItem(["temp_cache.bin", "C:\\Windows\\Temp", "Windows Temp", "15 MB", "Low"])
        item2 = QTreeWidgetItem(["old_installer.exe", "C:\\Users\\PC\\Downloads", "Downloads", "120 MB", "Medium"])
        ...
        btn_clean.setStyleSheet("padding: 10px 20px; background-color: #F44336; color: white; border-radius: 6px; font-weight: bold;")
        btn_quarantine = QPushButton("Quarantine Selected")
        btn_quarantine.setStyleSheet("padding: 10px 20px; background-color: #FF9800; color: white; border-radius: 6px; font-weight: bold;")
